/**
 * Google OAuth Service - Simplified and Clean
 */
...
class GoogleAuthService {
  ...
  constructor() {
    ...
    if (!this.clientId || !this.clientId.includes('.apps.googleusercontent.com')) {
      console.warn('Google Client ID is not properly configured.');
    }
  }
